    ...
    <div class="device-frame" data-player-open="false">
      ...
      <aside class="account-sheet" id="accountSheet" aria-hidden="true" aria-labelledby="accountSheetTitle" hidden>
        ...
        <section class="account-own-account-card">
          <div><strong>Want your own account?</strong><span id="androidAppText">This web player signs in as one shared YouTube account — whoever set up the server. For your own library and recommendations, install the OpenTune Android app and sign in there on your own phone.</span></div>
          <a class="account-primary" id="androidAppLink" href="#" target="_blank" rel="noopener noreferrer" hidden>Get the Android app</a>
        </section>
        ...
        <section class="account-server-login-card" id="serverLoginCard" hidden>
          <div><strong>Sign in from your home network</strong><span id="serverLoginText">A Google login can only be captured on the machine running the server, or on your home wi-fi. Open one of these there, then sign in.</span></div>
          <ul class="account-signin-urls" id="serverLoginUrls"></ul>
        </section>
